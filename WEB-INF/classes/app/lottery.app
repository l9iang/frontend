...
<app name="网站管理" iconCls="fa fa-desktop">
    <catagory id="CONFIG" name="网站管理" iconCls="fa fa-users">
        ...
        <module id="rechargeVote" name="充值赚金" script="app.ux.MyListView" iconCls="fa fa-user">
            <properties>
                <p name="entityName">RechargeVote</p>
                <p name="listService">myListServiceInt</p>
            </properties>
            <action id="query" name="搜索" iconCls="fa fa-search"/>
        </module>

        <module id="waterLog" name="服务费提成" script="app.ux.MyListView" iconCls="fa fa-user">
            <properties>
                <p name="entityName">WaterLog</p>
                <p name="listService">myListServiceInt</p>
            </properties>
            <action id="query" name="搜索" iconCls="fa fa-search"/>
        </module>
        ...
        <module id="robotUsers" name="机器人用户" script="app.chat.UserListView" iconCls="fa fa-user">
            ...
            <action id="setHeadImg" name="批量更新头像" iconCls="fa fa-edit" />
            <action id="setRobotMoney" name="批量更新余额" iconCls="fa fa-edit" />
             
        </module>


 
        <module id="notice" name="公告管理" script="app.ux.MyListView" iconCls="fa fa-user">
            <properties>
         ...
         <module id="massMessage" name="群发消息" script="app.ux.MyListView" iconCls="fa fa-user">
            <properties>
                <p name="entityName">MassMessage</p>
                <p name="listService">massMessageService</p>
            </properties>
            <action id="create" name="新增" iconCls="fa fa-create"/>
    ...
    <catagory id="shopCatalog" name="活动商城管理" iconCls="fa fa-users">
        <module id="shop" name="活动商品管理" script="app.ux.MyListView" iconCls="fa fa-user">
            <properties>
    ...
    <catagory id="RECHARGE_WITHDRAW" name="充值金币流转管理" iconCls="fa fa-users">
        ...
        <module id="withdraw" name="金币流转管理" script="app.ux.MyListView" iconCls="fa fa-gift">
            <properties>
        ...
        <module id="bankinfo" name="客户金币流转账号" script="app.ux.MyListView" iconCls="fa fa-cogs">
            <properties>
    ...
    <catagory id="room" name="房间管理" iconCls="fa fa-users">
        <module id="roomList" name="房间列表" script="app.ux.MyListView" iconCls="fa fa-gift">
            ...
            <action id="update" name="修改" iconCls="fa fa-edit"/>
            <action id="delete" name="删除" iconCls="fa fa-edit"/>
            <action id="updeteRoomByBatch" name="批量更新运行时虚拟增加人数" iconCls="fa fa-edit"/>
        </module>
        ...
        <module id="robotList" name="机器人分配管理" script="app.ux.MyListView" iconCls="fa fa-gift">
            <properties>
            ...
            <action id="update" name="修改" iconCls="fa fa-edit"/>
             ...
             <action id="updateByBatch" name="批量分配机器人" iconCls="fa fa-edit"/>
             <action id="updateAddByBatch" name="批量增加机器人" iconCls="fa fa-edit"/>
        </module>  
    </catagory>

    <catagory id="BET" name="红包游戏" iconCls="fa fa-users">
        <module id="detail" name="抢包明细" script="app.chat.RedDetailListView" iconCls="fa fa-gift">
            <properties>
        ...
        <module id="lotteryMain" name="发包明细" script="app.ux.MyListView" iconCls="fa fa-gift">
            <properties>
                <p name="entityName">LotteryMain</p>
                <p name="listService">myListServiceInt</p>
            </properties>
            <action id="query" name="搜索" iconCls="fa fa-search"/>
            <action id="read" name="查看" iconCls="fa fa-search-plus"/>
...
-->
    ...
    <catagory id="PCDD" name="北京28" iconCls="fa fa-users">
        ...
        <catagory id="PCDDJND" name="加拿大28" iconCls="fa fa-users">
        <module id="betLogjnd" name="下注明细" script="app.ux.MyListView" iconCls="fa fa-gift">
            <properties>
                <p name="entityName">GameLogForJnd</p>
                <p name="listService">myListServiceInt</p>
            </properties>
            <action id="query" name="搜索" iconCls="fa fa-search"/>
        </module>
        <module id="rateControljnd" name="赔率控制" script="app.ux.MyListView" iconCls="fa fa-gift">
            <properties>
                <p name="entityName">PcRateConfigForJnd</p>
                <p name="listService">myListServiceInt</p>
            </properties>
            <action id="update" name="修改" iconCls="fa fa-edit"/>
        </module>
        <module id="pcConfigjnd" name="蛋蛋配置" script="app.chat.PcParamForJndListView" iconCls="fa fa-gift">
            <properties>
                <p name="entityName">PcParamsForJnd</p>
                <p name="listService">pcParamsForJndSerice</p>
            </properties>
            <action id="update" name="修改" iconCls="fa fa-edit"/>
             <action id="reset" name="重启动配置器对象"  iconCls="fa fa-delete"/>
        </module>
