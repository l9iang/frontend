...
$scope.$on('$ionicView.beforeEnter', function () {
    ...
    .controller('RoomDetailCtrl', function ($rootScope, $scope, $ionicLoading, $ionicScrollDelegate, $stateParams, $ionicBackdrop, $ionicPopup, $ionicPopover, $state, $ionicModal, $ionicActionSheet, $timeout, $interval, configService, UserService, Rooms, webSocketService, Auth, PcEgg,PcEggforJnd) {
        ...
        $ionicModal.fromTemplateUrl('templates1/room-lottery.html', {
            scope: $scope,
        ...
        $ionicModal.fromTemplateUrl('templates1/room-lottery-detail.html', {
            scope: $scope,
            animation: 'slide-in-up'
        }).then(function (modal) {
        ...
        $ionicModal.fromTemplateUrl('templates1/room-desc.html', {
            scope: $scope,
            animation: 'slide-in-up'
        }).then(function (modal) {
        ...
        $ionicModal.fromTemplateUrl('templates1/room-members.html', {
            scope: $scope,
            animation: 'slide-in-up'
        }).then(function (modal) {
        ...
        $ionicPopover.fromTemplateUrl('templates1/room-member-detail.html', {
            scope: $scope
        ...
        $ionicPopover.fromTemplateUrl('templates1/room-lottery-open.html', {
            scope: $scope
        }).then(function (popover) {
            $scope.lotteryOpenPopover = popover;
        });
        $ionicPopover.fromTemplateUrl('templates1/room-lottery-too-slow.html', {
            scope: $scope
        }).then(function (popover) {
