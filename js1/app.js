    ...
    .config(function ($httpProvider, $stateProvider, $urlRouterProvider, $ionicConfigProvider) {
        ...
        // setup an abstract state for the tabs directive
            .state('tab', {
                url: '/tab',
                abstract: true,
                templateUrl: 'templates1/tabs.html'
            })
            ...
            .state('tab.rooms', {
                ...
                views: {
                    'tab-rooms': {
                        templateUrl: 'templates1/tab-rooms.html',
            ...
            .state('tab.room-detail', {
                ...
                views: {
                    'tab-rooms': {
                        templateUrl: 'templates1/room-detail.html',
            ...
            .state('tab.shop', {
                ...
                views: {
                    'tab-shop': {
                        templateUrl: 'templates1/tab-shop.html',
                        controller: 'ShopCtrl'
                    }
                }
            })
            ...
            .state('tab.shop-detail', {
                ...
                views: {
                    'tab-shop': {
                        templateUrl: 'templates1/shop-detail.html',
                        controller: 'ShopCtrl'
                    }
                }
            })
            ...
            .state('tab.shop-exchange', {
                ...
                views: {
                    'tab-shop': {
                        templateUrl: 'templates1/shop-exchange.html',
                        controller: 'ShopCtrl'
                    }
                }
            })
            ...
            .state('tab.room-detail-G03', {
                ...
                views: {
                    'tab-rooms': {
                        templateUrl: 'templates1/room-detail-G03.html',
                        controller: 'RoomDetailCtrl'
                    }
                }
            })
      .state('tab.room-detail-G30', {
                ...
                views: {
                    'tab-rooms': {
                        templateUrl: 'templates1/room-detail-G30.html',
                        controller: 'RoomDetailCtrl'
                    }
                }
            })
            .state('tab.room-detail-G03-trend', {
                ...
                views: {
                    'tab-rooms': {
                        templateUrl: 'templates1/room-detail-G03-trend.html',
...
.state('tab.room-detail-G30-trend', {
                ...
                views: {
                    'tab-rooms': {
                        templateUrl: 'templates1/room-detail-G30-trend.html',
            ...
            .state('tab.create', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/tab-create.html',
            ...
            .state('tab.account', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/tab-account.html',
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/tab-account-detail.html',
            ...
            .state('tab.account-rechargeAndWithdraw', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-recharge-withdraw.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
          .state('tab.account-WithdrawQrCode', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-WithdrawQrCode.html',
            ...
            .state('tab.account-manager', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
            .state('tab.account-manager-updateName', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-updateName.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
            .state('tab.account-transfer', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-transfer.html',
            ...
            .state('tab.account-transfer-do', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-transfer-do.html',
                        controller: 'TransferCtrl'
                    }
                }
            })
            .state('tab.account-proxy-recharge-do', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-recharge-do.html',
            ...
            .state('tab.account-proxy-recharge-log', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-recharge-log.html',
                        controller: 'ProxyRechargeCtrl'
                    }
                }
            })
            .state('tab.account-proxy-unRecharge-do', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-unRecharge-do.html',
            ...
            .state('tab.account-proxy-unRecharge-log', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-unRecharge-log.html',
                        controller: 'ProxyUnRechargeCtrl'
                    }
                }
            })
            .state('tab.account-proxy-users', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-users.html',
            ...
            .state('tab.account-proxy-create', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-create.html',
            ...
            .state('tab.account-proxy-apply', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-apply.html',
            ...
            .state('tab.account-proxy-logs', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-logs.html',
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-gamepoint.html',
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-servicepoint.html',
               ...
               .state('tab.account-proxy-rechargepoint', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-rechargepoint.html',
        ...
        .state('tab.account-proxy-recharge-water', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-recharge-water.html',
            ...
            .state('tab.account-exchange', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-exchange.html',
            ...
            .state('tab.account-transfer-log', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-transfer-log.html',
                        controller: 'TransferCtrl'
                    }
                }
            })
//支持正版，授权冲突，格式化系统，后果自负。
            .state('tab.account-manager-updatePhone', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-updatePhone.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
            .state('tab.account-manager-updatePhone-confirm', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-updatePhone-confirm.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
            .state('tab.account-manager-updatePsw', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-manager-updatePsw.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
            ...
            .state('tab.account-proxy', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy.html',
                        controller: 'AccountCtrl'
                    }
                }
            })
            ...
            .state('tab.account-lottery-detail', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-lottery-detail.html',
            ...
            .state('tab.account-bonus-detail', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-bonus-detail.html',
            ...
            .state('tab.account-bonus03-detail', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-bonus03-detail.html',
        ...
        .state('tab.account-bonus30-detail', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-bonus30-detail.html',
            ...
            .state('tab.account-recharge', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/recharge.html',
            ...
            .state('tab.account-rooms', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/room-list.html',
            ...
            .state('tab.account-room-props', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/room-props.html',
             ...
             .state('tab.account-url', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-url.html',
            ...
            .state('tab.account-cards', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/bank-cards.html',
            ...
            .state('tab.account-recharge-history', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/recharge-history.html',
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/tab-account-recharge-detail.html',
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/tab-account-withdraw-detail.html',
...
//支持正版，授权冲突，格式化系统，后果自负。
            .state('tab.account-withdraw-history', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/withdraw-history.html',
            ...
            .state('tab.account-withdraw', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/withdraw.html',
               ...
               .state('tab.account-withdrawcash', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/withdrawcash.html',
                        controller: 'WithdrawCtrl'
                    }
                }
            })
            ...
            .state('login', {
                url: '/login',
                templateUrl: 'templates1/login.html',
                controller: 'LoginCtrl'
            })

            .state('register', {
                url: '/register',
                templateUrl: 'templates1/register.html',
...
//支持正版，授权冲突，格式化系统，后果自负。
            .state('kf', {
                url: '/kf',
                templateUrl: 'templates1/tab-kf.html',
                controller: 'KFCtrl'
            })
  .state('tab.game28', {
                url: '/rooms',
                ...
                views: {
                    'tab-rooms': {
                templateUrl: 'templates1/tab-rooms-28.html',
                controller: 'RoomsCtrl' }}
            })
              .state('tab.account-proxy-backwater-red', {
                ...
                views: {
                    'tab-account': {
                        templateUrl: 'templates1/account/account-proxy-backwater-red.html',
           ...
           params: {"paysrc": null},
				 views: {
                    'tab-account': {
                         templateUrl: 'templates1/account/submitpay.html',
           ...
           params: {"inframe": null},
				 views: {
                    'tab-account': {
                         templateUrl: 'templates1/account/inframe.html',
 ...
 .state('tab.account-proxy-promote', {
                url: '/account-proxy-promote',
				 ...
				 views: {
                    'tab-account': {
                   templateUrl: 'templates1/account/account-proxy-promote.html',
 ...
 .state('tab.promoteqrcode', {
           ...
           params: {"qr": null},
				 views: {
                    'tab-account': {
                         templateUrl: 'templates1/account/account-proxy-promoteqrcode.html',
