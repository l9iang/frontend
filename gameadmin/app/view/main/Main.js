    ...
    loadMainAppItems:function(apps){
        ...
        return [{
            ...
            items: [{
                ...
                closable: false,
                padding: 10,
                html: $user.username+', 欢迎您使用iMax娱乐管理系统,本系统仅限学习和研究，禁止用于非法商业用途，责任自负,本站无关联责任,请遵守国家法律法规，做一个合格的公民。<br\>全网唯一独家玩家赢率全周期智能控制，充值、游戏提成、服务费三级返点，灵活配置返点比例，各种安全和运行策略灵活配置<br\>当前时间为 '+new Date().toLocaleString()+'更多支持和二次卡发联系qq：2035450966'
                //xtype: 'app-dashboard'
            }]
        }];
    }
